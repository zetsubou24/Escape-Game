...
function GamePage3(props) {
  ...
  const [state, setState] = useState({
    ...
    1: { name: "puzzle_2", category: "game",  description:[<span>These seem to be pieces of some picture. <br/>They fell out of my journal so I think there might be something in this picture that can help me out!<br/>You'll get to see what needs to be detected when everything is arranged.</span> ]
  ,hints:["Puzzle out the pictures in order to find the code. There are two faces for a coin","11-JAN-2030"] ,links:[]},
    ...
    3: { name: "puzzle_4", category: "game", description:[<span>"If you do not change direction, you may end up where you are heading" Lao Tzu"<br/>Move a mile straight, then two miles right. Repeat this again and go a mile straight. Three miles to left, then a mile straight once more. That’s how you reach what you are looking for.</span>
    ] ,hints:["<L_R_1>","<L_R_2>"],links:["/Puz4Desc","/Puz4Desc2"]},
    4: { name: "puzzle_5", category: "game", description:[<span> IF YOU COMBINE 80 UNITS OF <p style={{color:"red",display:"inline"}}>HYDROGEN </p>AND  THEN OXYGEN  UNITS  EQUAL TO HALF THE AMOUNT OF HYDROGEN . <br/> THIS REACTION PRODUCES POWER AND THEN WATER   UNITS EQUAL TO THE AMOUNT OF OXYGEN PLUS 20 UNITS</span>
    ],hints:["Use right colours of Water,Hydrogen and Oxygen","80 litres/min H2 40 litres/min O2 and about 60 grams/min H20"],links:[]},
    5: { name: "puzzle_6", category: "game", description:[<span>This seems to be some sort of control system device that fell out of the spaceship suit. Maybe I can learn it for starting my Emergency rover.</span> ]
    ...
    6: { name: "puzzle_7", category: "game", description:[<span>Oh YES! That's the Emergency Rover! <br/> But it seems to be in unpacked shape </span>]
    ...
    0: { name: "puzzle_7", category: "game", description:[<span>Oh YES! That's the Emergency Rover! <br/> But it seems to be in unpacked shape </span> ]
    ,hints:["Assemble the missing parts of the rover","Drag the parts from the inventory and assemble them to the rover at right location"],links:[]},
