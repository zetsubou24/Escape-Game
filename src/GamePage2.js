...
function GamePage2() {
  var players_available=8
  var max_players=10
  const [level, setLevel] = useState(0)
  const [temp,setTemp]=useState([])
  const [state, setState] = useState({
    tasks: [
      { name: "Circuit_Board", category: "game", bgcolor: "yellow", level: "one" },
      { name: "Screwdriver", category: "game", bgcolor: "pink", level: "one" },
      { name: "wires", category: "game", bgcolor: "skyblue", level: "one" }
    ],
    tasks2: [
      { name: "resistors", category: "game", bgcolor: "yellow", level: "two" },
      { name: "transistors", category: "game", bgcolor: "pink", level: "two" }
    ],
    tasks3: [
      { name: "Map", category: "game", bgcolor: "yellow", level: "two" },
      { name: "Graphite", category: "game", bgcolor: "pink", level: "two" }
    ]
  })
