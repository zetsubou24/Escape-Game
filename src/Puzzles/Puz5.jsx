			...
			<tr>
				...
				<td>
					<div id="container">
						...
						<button onClick={reset1} className="reset_button">reset</button>
				...
				<td>
					<div className="glass2_width"><h1 style={{ color: "white" }}>+</h1></div>
				</td>
				<td>
				{/* <div style={{width:"100%",height:"5px",backgroundColor:color[dp2]}}/>  */}
					<div id="container">
						...
						<button onClick={reset2} className="reset_button" >reset</button>
						<div class="ui compact menu" >
							<div class="ui simple dropdown item"  >
								Fill With
								<i class="dropdown icon"></i>
				...
				<td>
					<div className="glass3_width" ><h1 style={{ color: "white" }}>=</h1></div>
				</td>
				<td>
					<div id="container">
						<div id="glass3" >
						...
						<button onClick={reset3} className="reset_button">reset</button>
						<div class="ui compact menu">
							<div class="ui simple dropdown item"  >
								Fill With
								<i class="dropdown icon"></i>
				...
				<td>
					<div className="glass1_width"><h1 style={{ color: "white" }}>+</h1></div>
				</td>
				<td>
