...
const Puz2 = (props) =>{
    ...
    const [grid,setGrid]=useState({
        tasks:[
          {name:"10",curarea:"puzzle",bgcolor:"white",bg:"images/dummy1.jpeg",bg2:"images/dummy1.jpeg"},
            ...
            {name:"11",curarea:"puzzle",bgcolor:"white",bg:"images/dummy2.jpeg",bg2:"images/dummy2.jpeg"},
            ...
            {name:"12",curarea:"puzzle",bgcolor:"white",bg:"images/dummy3.jpeg",bg2:"images/dummy3.jpeg"}
            
        ]
    })
    let [curImg,setCurImg]=useState({
      "12":{img:"images/dummy3.jpeg",index:0},
      "1":{img:"images/Puzzle2frontface/image_part_001.jpg",index:0},
      "2":{img:"images/puzzle2frontface/image_part_002.jpg",index:0},
      "10":{img:"images/dummy1.jpeg",index:0},
      ...
      "11":{img:"images/dummy2.jpeg",index:0},
    ...
    <div className="center_main">
          <div className="mtb_mb" style={{display:"flex",alignItems:"row", width:"100%"}}>
          <Input className="width_mb_73" type="text" placeholder=""  value={ans} onChange={(ev)=>setAns(ev.target.value)} style={{opacity:0.7}}/><br/>
