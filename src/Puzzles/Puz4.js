...
let onReset = () => {
  ...
  return (
    <div className="position_cls">
    <div className="puz4-items" style={{backgroundSize:"cover", width: "100%"}}>
    {/* <div>
    ...
    <div className="pattern_box" style={{backgroundImage:`url('images/mars-map.png')`,backgroundSize:"cover"}} >
    <PatternLock
    size={5}
    onChange={onChange}
